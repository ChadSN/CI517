...
// ADJUSTED COLORS TO INCLUDE ALPHA CHANNEL
static const SDL_Color SDL_COLOR_GRAY = { 0x80, 0x80, 0x80, 255 };
static const SDL_Color SDL_COLOR_YELLOW = { 0xFF, 0xFF, 0, 255 };
static const SDL_Color SDL_COLOR_RED = { 0xFF, 0, 0, 255 };
static const SDL_Color SDL_COLOR_GREEN = { 0, 0xFF, 0, 255 };
static const SDL_Color SDL_COLOR_BLUE = { 0, 0, 0xFF, 255 };
static const SDL_Color SDL_COLOR_BLACK = { 0, 0, 0, 255 };
static const SDL_Color SDL_COLOR_WHITE = { 0xFF, 0xFF, 0xFF, 255 };
static const SDL_Color SDL_COLOR_AQUA = { 0, 0xFF, 0xFF, 255 };
static const SDL_Color SDL_COLOR_ORANGE = { 0xFF, 0xA5, 0, 255 };
static const SDL_Color SDL_COLOR_PINK = { 0xFF, 0xC0, 0xCB, 255 };
static const SDL_Color SDL_COLOR_PURPLE = { 0x80, 0, 0x80, 255 };
static const SDL_Color SDL_COLOR_VIOLET = { 0xEE, 0x82, 0xEE, 255 };
